...
export default function EditModal({ productGroups, product, setView }) {
    ...
    const handleUpdate = async (e) => {
        ...
        const result = await updateProduct(newproductData);
    ...
    // console.log(newproductData.img.split('/').pop());
    // console.log(newproductData.img.split('/object/public/'))[1].split('/').slice(1).join('/');
    ...
    return (
        <div className={styles.modalContainer}>
            ...
            <div className={styles.containerOne}>
                ...
                <h2 className={styles.title}>EDIT &quot;{product.title}&quot;<hr /></h2>
